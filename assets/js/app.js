          ...
          var e,
            ...
            n =
              (e /= o / 2) < 1
                ? (n / 2) * e * e + t
                : (-n / 2) * (--e * (e - 2) - 1) + t;
          (a.scrollTop = n), r < o && setTimeout(c, 20);
        }
        null != t &&
          ...
          e) &&
          100 < t &&
          ((o = 600), (i = (a = e).scrollTop), (s = t - i), (r = 0), c());
      }, 200));
  }
  var n, a, i, s, r;
  e(),
...
class ThemeCustomizer {
  ...
  setSwitchFromConfig() {
      localStorage.setItem("__HP9X_CONFIG__", JSON.stringify(this.config)),
      document
    ...
    c &&
      ((e = document.querySelector(
        "input[type=radio][name=data-layout][value=" + c.nav + "]"
      )),
      (t = document.querySelector(
        "input[type=radio][name=data-bs-theme][value=" + c.theme + "]"
      )),
      (n = document.querySelector(
        "input[type=radio][name=data-layout-mode][value=" + c.layout.mode + "]"
      )),
      ...
      (o = document.querySelector(
        "input[type=radio][name=data-menu-color][value=" + c.menu.color + "]"
      )),
